            ...
            if not obs_data:
                ...
                if obs_data.get("status") == "SUCCESS":
                    if "data" in obs_data:
                        d = obs_data["data"]
                        final_answer = (
                            f"Kết quả tra cứu ticket {obs_data.get('ticket_id', '')}: "
                            f"Loại sự cố: {d.get('issue_type', '')}, Trạng thái: {d.get('status', '')}, "
...
if __name__ == "__main__":
    ...
    if "--interactive" in sys.argv:
        ...
        print("   - Câu hỏi chung: 'Quy trình gửi yêu cầu hỗ trợ IT trong công ty là gì?'")
        print("   - Tra cứu ticket: 'Hãy tra cứu tình trạng ticket TCK-1001 giúp tôi'")
        print("   - Tạo ticket mới: 'Tôi là nhân viên NV2026003, laptop lỗi không cài được phần mềm, tạo giúp tôi 1 yêu cầu hỗ trợ ưu tiên cao'")
